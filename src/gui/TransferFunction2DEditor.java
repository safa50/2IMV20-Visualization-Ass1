...
public class TransferFunction2DEditor extends javax.swing.JPanel {
    ...
    public class TriangleWidget {
        ...
        // extend parameters by taking Kniss constraints into account
        public double maxKnissGradMag;
        public double minKnissGradMag;      
        ...
        // extended Kniss triangleWidget
        public TriangleWidget(short base, double r, double minKnissGradMag, double maxKnissGradMag) {
            this.baseIntensity = base;
            this.radius = r;
            this.color = new TFColor(0.0, 204.0/255.0, 153.0/255.0, 0.3);
            this.maxKnissGradMag = maxKnissGradMag;
            this.minKnissGradMag = minKnissGradMag;
        }
    }
